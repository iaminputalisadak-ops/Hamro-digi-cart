...
-- Create database
CREATE DATABASE IF NOT EXISTS hamrodigicart CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE hamrodigicart;
...
-- Insert default admin (username: hamrodigicart1, password: admin123)
-- Password is hashed using password_hash() - default: admin123
INSERT INTO admins (username, password, email) VALUES 
('hamrodigicart1', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@hamrodigicart.com')
